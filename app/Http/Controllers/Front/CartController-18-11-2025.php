...
use App\Models\{ProductVariantCombination, VariantValue, Coupon};
...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        try {
            ...
            if (!$productId || !is_array($selectedVariants)) {
    ...
    public function getCartItems(Request $request)
    {
        try {
            ...
            foreach ($carts as $cart) {
                ...
                $selectedVariants = [];
                $combinationId = $cart->productVariantCombination->combination_id;
                $combinationIds = json_decode($combinationId, true);
