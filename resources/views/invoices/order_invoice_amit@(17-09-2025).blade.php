         ...
         <tr>
            <td>
               <table  width="100%">
                  <tr>
                     <td>
                        <p style="font-size: 16px; margin-bottom: 5px; margin-top: 5px;font-family: 'Nunito Sans', sans-serif;"><b>Invoice Number:</b> {{ $supplySetting->invoice_number }}{{ $order->id }}  </p>
                        <p style="font-size: 16px; margin-bottom: 5px; margin-top: 5px;font-family: 'Nunito Sans', sans-serif;"><b>Order Number:</b> {{ $order->order_number }}</p>
                        <p style="font-size: 16px; margin-bottom: 5px; margin-top: 5px;font-family: 'Nunito Sans', sans-serif;"><b>Nature of Transaction:</b> {{ $order->payment_method }}</p>
                     ...
                     <td align="right">
                        <p style="font-size: 16px; margin-bottom: 5px; margin-top: 5px;font-family: 'Nunito Sans', sans-serif;"><b>PacketID:</b> {{ $supplySetting->packet_id }}{{ $order->id }}   </p>
                        <p style="font-size: 16px; margin-bottom: 5px; margin-top: 5px;font-family: 'Nunito Sans', sans-serif;"><b>Invoice Date: </b> {{ $order->created_at }}</p>
                        <p style="font-size: 16px; margin-bottom: 5px; margin-top: 5px;font-family: 'Nunito Sans', sans-serif;"><b>Order Date:</b> {{ $order->created_at }}</p>
                        <p style="font-size: 16px; margin-bottom: 5px; margin-top: 5px;font-family: 'Nunito Sans', sans-serif;"><b>Nature of Supply:</b> {{ $supplySetting->nature_spilly }}</p>
                     </td>
                  </tr>
               </table>
            </td>
         ...
         <tr >
            <td>
               <table width="100%" >
                  <tr>
                     <td width="50%">
                        <p style="margin-bottom: 10px;font-size: 16px;font-family: 'Nunito Sans', sans-serif;"><b >Bill to / Ship to:</b></p>
                        <p style="margin-bottom: 0;margin-top: 0;font-size: 16px;font-family: 'Nunito Sans', sans-serif;">{{ $bAddress->billing_customer_name }}</p>
                        <p style="margin-bottom: 0;margin-top: 0;font-size: 16px;font-family: 'Nunito Sans', sans-serif;">{{ $supplySetting->address }} {{ $supplySetting->pincode }}</p>
                        <p style="margin-bottom: 0;margin-top: 0;font-size: 16px;font-family: 'Nunito Sans', sans-serif;">{{ $supplySetting->city->name }}, {{ $supplySetting->state->name }}, {{ $supplySetting->country->name }}</p>
                     </td>
                     <td width="50%">
                  ...
                  <tr style="vertical-align: top;">
                     <td>
                        ...
                        <p style="margin-bottom: 0;margin-top: 0;font-size: 16px;font-family: 'Nunito Sans', sans-serif;">{{ $bAddress->billing_address }}</p>
                        <p style="margin-bottom: 0;margin-top: 0;font-size: 16px;font-family: 'Nunito Sans', sans-serif;">{{ $bAddress->billing_city }} ({{ $bAddress->billing_pincode }}), {{ $bAddress->billing_state }}, {{ $bAddress->billing_country }}</p>
                        <p style="font-size: 16px;font-family: 'Nunito Sans', sans-serif;"><b>GSTIN Number:</b> {{ $GSTIN }} </p>
                     </td>
                     <td>
                        <p><b>Ship From: </b></p>
                        <p style="margin-bottom: 0;margin-top: 0;font-family: 'Nunito Sans', sans-serif;">{{ $supplySetting->website_name }}</p>
               ...
               <table width="100%">
                  ...
                  @if(!empty($checkout_data))
                     @foreach($checkout_data as $checkout)
                        ...
                        <tr>
                           <td colspan="9">
                              <p style="margin-top: 0; font-size: 20px; margin-bottom: 0;font-size: 18px;font-family: 'Nunito Sans', sans-serif;"><b> {{ $checkout['name'] ?? '' }}, Size: {{ $checkout['selectedVariants']['size'] ?? '' }} , Color: {{ $checkout['selectedVariants']['colour'] ?? '' }} </b></p>
                              <p style="margin-top: 0; font-size: 20px; font-size: 18px;font-family: 'Nunito Sans', sans-serif;"><b>HSN: 62114210, {{ $checkout['tax_rate'] }} % </b></p>
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td style="font-size: 14px;font-family: 'Nunito Sans', sans-serif;">Rs 0.00</td>
                           <td style="font-size: 14px;font-family: 'Nunito Sans', sans-serif;">Rs {{ number_format(($checkout['sellingPrice'] ?? 0) * ($checkout['quantity'] ?? 0), 2) }}</td>
                           ...
                           <td align="right" style="font-size: 14px;font-family: 'Nunito Sans', sans-serif;">Rs {{ number_format((($checkout['sellingPrice'] ?? 0) + ($checkout['tax_price'] ?? 0)) * ($checkout['quantity'] ?? 0), 2) }}</td>
                  ...
                  <tr>
                     ...
                     <td style="font-size: 14px;font-family: 'Nunito Sans', sans-serif;"><b>Rs {{ number_format((($order['sub_total'] ?? 0) + ($discount)), 2) }}</b></td>
                     ...
                     <td style="font-size: 14px;font-family: 'Nunito Sans', sans-serif;"><b>Rs {{ number_format($order['total'] ?? 0, 2) }}</b></td>
                     ...
                     <td style="font-size: 14px;font-family: 'Nunito Sans', sans-serif;" align="right"><b>Rs {{ number_format((($order['total'] ?? 0) + ($igstTaxTotal)), 2) }}</b></td>
                  </tr>
                  <tr>
                     <td colspan="9">
                        <hr>
               ...
               <table width="100%">
                  <tr>
                     <td style="vertical-align: text-top;">
                        <p  style="margin-bottom: 40px;font-family: 'Nunito Sans', sans-serif;"><b>FOR {{ $supplySetting->website_name }} </b></p>
                        ...
                        <p  style="margin-top: 20px;font-family: 'Nunito Sans', sans-serif;">Authorized Signatory </p>
                     </td>
