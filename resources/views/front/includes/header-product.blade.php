                            ...
                            <div class="hover-panel">
                                <div class="hover-content">
                                    ...
                                    <!--div class="product-actions">
                                        <a href="@if(!empty($product->sku)){{ route('front-product.detail', ['product' => 'product','title' =>productSlug($product->name).'.html', 'sku' => $product->sku]) }}@endif" class="action-btn add_to_cart_btn">
                                            Buy now
                                        </a>
                                    </div-->
                                </div>
