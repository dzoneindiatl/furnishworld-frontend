...
@section('content')
                                ...
                                <div class="myaccout-content-wrapper">
                                    ...
                                    <div class="account-section">
                                        ...
                                        <div class="account-body">
                                            ...
                                            <div class="account-form">
                                                <form action="{{ route('front-user.updateProfile') }}" method="post"
                                                    role="form">
                                                    @csrf
                                    ...
                                    <div class="shipping-section">
                                        ...
                                        <div class="shipping-address">
                                            <h5 class="shipping-add-title">Billing Addrress</h5>
                                                            ...
                                                            <label class="shipping-address-label"
                                                                ...
                                                                <p>{{ $billingAddress->name }} <span
                                                                    ...
                                                                    <span class="edit-address-btn"
                                                                        ...
                                                                        style="float: right;color: #216643;pointer:cursor;">Edit</span>
                                                                </p>
                                                                ...
                                                                <?php if ($billingAddress->is_primary == 1) {
                                                                    echo '<span style="float: left;color: #c2a188;pointer:cursor;">Primary</span>';
                                                                } ?>
                                                                <span id="removeAddressBtn" class="remove-address-btn"
                                                                    data-adddressId="{{ $billingAddress->id }}"
                                                                    style="float: right;color: #33895d;pointer:cursor;">Remove</span>
                                                            </label>
                                                        </div>
                                                    @endforeach
                                                @else
                                        ...
                                        <!-- shipping-section -->
                                        <div class="shipping-address">
                                            <h5 class="shipping-add-title">Shipping Addrress</h5>
                                            <div class="shipping-address-items">
                                        ...
                                        <div class="shipping-address p-0">
                                            <div class="shipping-add-new">
                                                <button id="add-new-address" class="btn-add-new"
                                                    data-bs-toggle="collapse" data-bs-target="#new-address">+ Add A New
                                                    Address</button>
                                            </div>
                                        </div>
                                            ...
                                            <form method="post" id="editAddressForm">
                                                ...
                                                <div class="new-add-row">
                                                    <div class="form-group half-right col-sm-6 col-12">
                                                        ...
                                                        <select class="form-select selectcommon requiredField"
                                                    ...
                                                    <div class="form-group half-left col-sm-6 col-12">
                                                        ...
                                                        <input type="text" name="address"
                                                            class="form-control requiredField" placeholder="Address"
                                                            required />
                                                    </div>
                                                    <div class="form-group half-right col-sm-6 col-12">
                                                        ...
                                                        <div class="form-check-list">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="address_place_type" id="home"
                                                                    value="1" checked>
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="address_place_type" id="office"
                                                                    value="2">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="address_place_type" id="Others"
                                                                    value="3">
                                                ...
                                                <div class="form-button">
                                                    ...
                                                    <button type="button"
                                                        class="cancel btn btn-secondary">Cancel</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Edit button
            $('.enable-value').on('click', function(e) {
                e.preventDefault();

                var section = $(this).closest('.account-section');

                // Content hide, form show
                section.find('.account-content').addClass('d-none');
                section.find('.account-form').removeClass('d-none');

                // Edit hide, Cancel show
                section.find('.enable-value').addClass('d-none');
                section.find('.disable-value').removeClass('d-none');
            });


            // Cancel button
            $('.disable-value').on('click', function(e) {
                e.preventDefault();

                var section = $(this).closest('.account-section');

                // Form hide, content show
                section.find('.account-form').addClass('d-none');
                section.find('.account-content').removeClass('d-none');

                // Cancel hide, Edit show
                section.find('.disable-value').addClass('d-none');
                section.find('.enable-value').removeClass('d-none');
            });
