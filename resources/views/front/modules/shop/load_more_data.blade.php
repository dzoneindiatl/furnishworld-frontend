                ...
                <div class="col-md-3">
                    <div class="product-card">
                        <figure class="item-single">
                            ...
                            <a href="{{ route('front-product.detail', ['product' => 'product','title' =>productSlug($product->name).'.html', 'sku' => $product->sku]). '?' . http_build_query(['colorArr' => $colorArr, 'sizeArr' => $sizeArr]) }}">
                            ...
                            <div class="price-btn-sec d-flex">
                                ...
                                <div class="add-cart-btn ms-4">
                                    ...
                                    <button type="button" 
                                        ...
                                        onclick="window.location.href='{{ route('front-product.detail', ['product' => 'product','title' =>productSlug($product->name).'.html', 'sku' =>$product->sku]) }}'">
                                        Add To Cart
                                    </button>
                                    @endif
                                </div>
