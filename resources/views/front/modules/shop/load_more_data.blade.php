                                     ...
                                     <li class="product-item product">
                                         <div class="product-wrap">
                                             <div class="product-image">
                                                 ...
                                                 <a
                                                     href="{{ route('front-product.detail', ['product' => 'product', 'title' => productSlug($product->name) . '.html', 'sku' => $product->sku]) }}">
                                                 ...
                                                 <div class="product-options">
                                                     <div class="product-option-item">
                                                         ...
                                                         <div class="product-addtocart-button">
                                                             <a href="#" class="product-addtocart">
                                                                 <div class="icon-cart-pro"><svg fill="#fff"
                                             ...
                                             <div class="product-content">
                                                 ...
                                                 <div class="product-price">
                                                     ...
                                                     <span class="single-product-priceoff" id="discountShow">20%
                                                         Off</span>
                                                 </div>
