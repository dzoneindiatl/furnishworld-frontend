              ...
              <div class="col-lg-7 col-md-12 col-12">
                ...
                <div class="shipping-section">
                  ...
                  <div class="form-group mb-3 col-sm-12 col-12 has-value">
                      <input class="form-check-input" type="checkbox" value="0" id="same_as_billing" name="same_as_billing" checked onclick="toggleShippingAddressForm()">
                  ...
                  <form action="">
                    <div class="checkout-payment-items">
                      <div class="checkout-payment-item">
                        <input class="checkout-payment-input" id="payment1" type="checkbox" name="wallet_online" value="wallet" @if(empty($userRecord->wallet_avl_balance) && is_null($userRecord->wallet_avl_balance)) disabled @endif onclick="togglewalletCod()">
                      ...
                      <div class="checkout-payment-item">
                        <input class="checkout-payment-input" id="payment2" type="radio" name="pay_online" value="razorpay">
                        <label class="checkout-payment-label" for="payment2">
                          <p class="checkout-payment-title"><img src="images/icon-upi.png" alt=""> Razorpay</p>
                          <div class="checkout-payment-box">
                      ...
                      <div class="checkout-payment-item">
                        <input class="checkout-payment-input" id="payment3" type="radio" name="pay_online" value="cod" /> 
                        <label class="checkout-payment-label" for="payment3">
                          <p class="checkout-payment-title"><img src="images/icon-cod.png" alt="">COD</p>
                          <div class="checkout-payment-box">                               
                ...
                <div class="mt-3">
                  ...
                  <button type="button" class="btn btn-primary py-3 btn-lg w-100" name="checkout_place_order" id="pay_now">Place your order</button>  
                  <p id="shoopping_continue" style="display:none;"><a href="<?php echo env('WEBSITE_URL'); ?>" class="btn btn-primary py-3 btn-lg w-100"> Continue Shopping</a></p>
                </div>                
                      ...
                      <div class="cart-totals-table">
                        ...
                        <tbody>
                            ...
                            <tr class="shipping-totals shipping">
                                ...
                                <td data-title="Shipping" class="text-end" id="totalShippingCharge"></td>
                            </tr>
                            <tr class="order-total">
                                <th><b>Total Payable</b> (Tax Included)</th>
                                <td data-title="Total" class="text-end"><strong  class="finalAmount"></strong></td>
                            </tr>
                        </tbody>
                      </table>
                      </div>                          
