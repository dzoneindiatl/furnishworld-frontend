                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10 mx-auto">
                            <div class="loginregister-area">
                                ...
                                <form action="{{ route('front-user.postSignup') }}" method="POST">
                                    ...
                                    <div class="form-focus row login-form-inner">
                                        <div class="form-group col-12">
                                            <label class="label-focus" for="name">Name <span
                                        ...
                                        <div class="form-group  col-12">
                                            ...
                                            <input type="text" class="form-control" id="referal" name="referral"
                                                placeholder="" />
                                        </div>
                                    </div>
                                ...
                                <div class="loginregister-footer">
                                    <p>Already have an account? <a href="{{ route('front-user.login') }}"
                                            class="ms-2 text-decoration-underline">Sign in?</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
